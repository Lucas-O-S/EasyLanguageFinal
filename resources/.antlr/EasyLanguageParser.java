...
public class EasyLanguageParser extends Parser {
	...
	public static final int
		...
		T__9=10, T__10=11, T__11=12, T__12=13, T__13=14, LINE_COMMENT=15, BLOCK_COMMENT=16, 
		AP=17, FP=18, OP=19, ACH=20, FCH=21, AND=22, OR=23, NOT=24, OPREL=25, 
		BOOL=26, CHAR=27, NUMBER=28, INTEGER=29, STRING=30, WS=31, DECIMAL=32, 
		BOOLEANO=33, TEXTO=34, INTEIRO=35, CARACTERE=36, VAZIO=37, ID=38, VIR=39, 
		ATTR=40, SC=41, AC=42, FC=43;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'retorne'", null, null, "'('", "')'", null, "'{'", "'}'", "'e'", "'ou'", 
			"'nao'", null, null, null, null, null, null, null, "'decimal'", "'booleano'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, "LINE_COMMENT", "BLOCK_COMMENT", "AP", "FP", "OP", 
			"ACH", "FCH", "AND", "OR", "NOT", "OPREL", "BOOL", "CHAR", "NUMBER", 
			"INTEGER", "STRING", "WS", "DECIMAL", "BOOLEANO", "TEXTO", "INTEIRO", 
			"CARACTERE", "VAZIO", "ID", "VIR", "ATTR", "SC", "AC", "FC"
		};
	}
	...
	public final BlocoContext bloco() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 545460852920L) != 0) );
			setState(107);
			match(FCH);
			}
		}
	...
	public final CmdselecaoContext cmdselecao() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 274877913272L) != 0) );
			setState(162);
			match(FCH);
	...
	public final CmdChamadaFuncaoContext cmdChamadaFuncao() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 276958412800L) != 0)) {
				{
				setState(269);
