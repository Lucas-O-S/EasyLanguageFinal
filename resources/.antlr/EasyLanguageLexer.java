...
public class EasyLanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "AP", "FP", "OP", "ACH", 
			"FCH", "AND", "OR", "NOT", "OPREL", "BOOL", "CHAR", "NUMBER", "INTEGER", 
			"STRING", "WS", "NUMERO", "BOOLEANO", "TEXTO", "INTEIRO", "CARACTERE", 
			"VAZIO", "ID", "VIR", "ATTR", "SC", "AC", "FC"
		};
	}
